...
POST_SMTP = 'smtp.mail.ru'
POST_IMAP = 'imap.mail.ru'
POST_PORT = 587


class Post:
    def __init__(self, login, password, smtp_port=POST_PORT, smtp=POST_SMTP,
                 imap=POST_IMAP):
        self.login = login
    ...
    def receive_message(self, directory='inbox', header=None):
...
if __name__ == '__main__':
    email_login = Post('nastena_pashina@list.ru', 'qwerty123')
    email_login.send_message('Subject', ['vasya@email.com', 'petya@email.com'],
                             'Message')
    print(email_login.receive_message())
...
#
# if __name__ == '__main__':
#     my_email = Mail('Kulikov077@gmail.com', 'Klepa1993')
#     my_email.send_message('Subject', ['nastena_pashina@list.ru'],
#                           'Message')
